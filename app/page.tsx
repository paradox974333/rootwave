                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
                  ...
                  <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      <div>
                        <h4 className="font-black mb-2 sm:mb-3 lg:mb-4 text-base sm:text-lg lg:text-xl text-gray-900 flex items-center">
                        ...
                        <ul className="space-y-1.5 sm:space-y-2 lg:space-y-3">
                          {[
                            ...
                            <li key={index} className="flex items-start space-x-2 sm:space-x-3">
                              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-full mt-[6px] sm:mt-2 flex-shrink-0"></div>
                      ...
                      <Button
                        className="group w-full px-4 sm:px-6 py-2.5 sm:py-3 lg:py-4 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700 hover:from-emerald-700 hover:via-green-700 hover:to-emerald-800 text-white text-xs sm:text-sm lg:text-base font-bold shadow-xl hover:shadow-emerald-500/25 transition-all duration-500 hover:scale-105 rounded-lg sm:rounded-xl"
                        onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}
                      >
                        <div className="flex items-center justify-center space-x-1.5 sm:space-x-2">
                          <MessageCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 lg:w-5 lg:h-5 group-hover:rotate-12 transition-transform duration-300" />
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block text-gray-700 text-lg sm:text-xl md:text-2xl lg:text-3xl font-light mt-2 sm:mt-3">Over Alternatives?</span>
            </h2>
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[600px] sm:min-w-[700px]">
                  <thead className="bg-gradient-to-r from-emerald-600 via-green-600 to-blue-600 text-white">
                    <tr>
                      <th className="p-3 sm:p-4 lg:p-5 text-left font-black text-xs sm:text-sm lg:text-base">Comparison Factor</th>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr
                        key={index}
                        className={`border-b hover:bg-gray-50 transition-colors ${index % 2 === 0 ? "bg-white" : "bg-gray-50/70"}`}
                      >
                        <td className="p-3 sm:p-4 lg:p-5 font-bold text-gray-900 text-[11px] sm:text-xs lg:text-sm">{row.factor}</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="relative p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-red-50 to-red-100 rounded-xl sm:rounded-2xl border-l-4 sm:border-l-6 border-red-500 shadow-lg">
              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 lg:top-4 lg:right-4">
                <div className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 bg-red-500 rounded-full flex items-center justify-center">
                  <span className="text-white font-bold text-xs sm:text-sm lg:text-base">!</span>
                </div>
              </div>
              <blockquote className="text-xs sm:text-sm lg:text-base text-red-800 italic font-bold leading-relaxed pr-6 sm:pr-8">
                "Every plastic straw used today becomes tomorrow's environmental burden – lasting centuries beyond its
                minutes of use."
              </blockquote>
            </div>

            <div className="relative p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl sm:rounded-2xl border-l-4 sm:border-l-6 border-orange-500 shadow-lg">
              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 lg:top-4 lg:right-4">
                <div className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 bg-orange-500 rounded-full flex items-center justify-center">
                  <span className="text-white font-bold text-xs sm:text-sm lg:text-base">?</span>
                </div>
              </div>
              <blockquote className="text-xs sm:text-sm lg:text-base text-orange-800 italic font-bold leading-relaxed pr-6 sm:pr-8">
